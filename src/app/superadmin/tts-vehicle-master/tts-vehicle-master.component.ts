...
@Component({
  ...
  templateUrl: './tts-vehicle-master.component.html',
  styleUrls: ['../../common.css','./tts-vehicle-master.component.css']
})
export class TtsVehicleMasterComponent implements OnInit{
        isAdd: boolean = true
